  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        id: 'diknas-presensi',
        label: 'Presensi',
        href: '/diknas/presensi',
        icon: ClipboardList,
        minRole: 'user',
      },
      {
        id: 'diknas-nilai-harian',
        label: 'Nilai Harian',
        href: '/diknas/nilai-harian',
        icon: FileText,
        minRole: 'user',
      },
      {
        id: 'diknas-nilai-uas',
        label: 'Nilai UAS',
        href: '/diknas/nilai-uas',
        icon: Award,
        minRole: 'user',
      },
      {
        id: 'diknas-catatan',
        label: 'Catatan Kelakuan',
        href: '/diknas/catatan',
        icon: BookOpen,
        minRole: 'user',
      },
      {
        id: 'diknas-bank-soal',
        label: 'Bank Soal',
        href: '/diknas/bank-soal',
        icon: List,
        minRole: 'user',
      },
      {
        id: 'diknas-rekap-nilai',
        label: 'Rekap Nilai',
        href: '/diknas/rekap-nilai',
        icon: TrendingUp,
        minRole: 'user',
      },
      {
        id: 'diknas-laporan-bulanan',
        label: 'Laporan Hasil Belajar',
        href: '/diknas/laporan-bulanan',
        icon: Printer,
        minRole: 'user',
      },
    ],
